...
const database = require("../config/database")({ pg, connectionString });
...
const logger = require("../api/middleware/logger")({ expressWinston, winston });
const validator = require("../api/middleware/validator")({ expressValidator });
...
const wishlistController = require("../api/controller/wishlist.controller")({
  models: { wishlist: wishlistModel, product: productModel },
});
